...
(function () {
	...
	function buildAdminPanel() {
		...
		panel.innerHTML = [
			...
			'  <h3>Utilisateurs a notifier par email</h3>',
			'</div>',
			...
			'    <option value="">Selectionner un utilisateur a ajouter...</option>',
			'  </select>',
			'  <button type="button" class="button" id="thirdpartynotify-add-user"><span class="fa fa-plus"></span> Ajouter</button>',
			'</div>',
			'<div class="thirdpartynotify-help"><span class="fa fa-info-circle"></span> Selectionnez les utilisateurs qui recevront les notifications par email concernant les evenements des tiers.</div>',
			'<div class="thirdpartynotify-selected-box">',
			'  <div class="thirdpartynotify-box-title">UTILISATEURS SELECTIONNES</div>',
